...
class RequerimentosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'justificativa' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-05-29 20:24:55',
                'modified' => '2018-05-29 20:24:55'
            ],
        ];
        parent::init();
    }
