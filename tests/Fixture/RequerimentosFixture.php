...
class RequerimentosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tiposrequerimentos_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'setores_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'Solicitante' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'tiposrequerimentos_id' => 1,
                'setores_id' => 1,
                'Solicitante' => 'Lorem ipsum dolor sit amet',
                'cursos_id' => 1,
                'cpf' => 1,
                'created' => '2018-05-28 19:35:55',
                'modified' => '2018-05-28 19:35:55'
            ],
        ];
        parent::init();
    }
