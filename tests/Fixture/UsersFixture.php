...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'matricula' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'cpf' => ['type' => 'string', 'length' => 225, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'perfis_id' => 1,
                'setores_id' => 1,
                'created' => '2018-05-27 22:32:23',
                'modified' => '2018-05-27 22:32:23'
            ],
        ];
        parent::init();
    }
